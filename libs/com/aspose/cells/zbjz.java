...
class zbjz
  extends zco
{
  static zn[] i = { new zn(0, 0), new zn(21600, 0), new zn(21600, 21600), new zn(0, 21600), new zn(0, 0), new zn(Integer.MIN_VALUE, -2147483647), new zn(-2147483646, -2147483645), new zn(-2147483644, -2147483643), new zn(-2147483644, 0), new zn(-2147483644, 21600) };
  static int[] j = { 4, 24576, 32768, 2, 43520, 32768, 1, 43520, 32803 };
  ...
  private int[] n = { 55456, 24300, 61936, 4050, 63736, 4050 };
  static zbbi[] m = { new zbbi(0, 0, 21600, 21600) };
  
  zbjz(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
    ...
    throws Exception
  {
    ...
    if (this.e.l.a.size() > 0)
    {
      ...
      this.n = new int[] { i5, i6, i7, i8, i9, i10 };
    }
    Object localObject1 = new zbo(i, j, l, this.n, m, 21600, 21600, Integer.MIN_VALUE, Integer.MIN_VALUE, k);
    if (this.e.m().d()) {
      this.e.m().a(Color.getWhite());
    }
    Object localObject2 = new zbn(51, i1, i2, i3, i4, this.e.n().c(), this.e.n().f(), this.e.m().b(), (zbo)localObject1);
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbjz.class
