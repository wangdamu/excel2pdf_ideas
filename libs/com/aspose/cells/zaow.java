...
class zaow
  implements zais
{
  static zaow a = new zaow();
  
  public double a(double paramDouble1, double paramDouble2)
  {
    return zga.b(paramDouble1 + paramDouble2);
  }
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zaow.class
