...
class zank
  extends zcp
{
  zank(zr paramzr, float paramFloat1, float paramFloat2, zbni paramzbni)
  {
    ...
    throws Exception
  {
    ...
    this.a.b(localzs, f1 + f9 + f17, f2 + f11 + f19, f1 + f10 + f17, f2 + f12 + f19);
    a();
  }
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zank.class
