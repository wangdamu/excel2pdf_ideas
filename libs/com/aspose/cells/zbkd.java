  ...
  extends zco
{
  ...
  static int[] j = { 4, 24576, 32784, 2, 43520, 32768 };
  ...
  zbkd(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
    ...
    throws Exception
  {
    ...
    Object localObject2 = new zbn(42, i1, i2, i3, i4, this.e.n().c(), this.e.n().f(), this.e.m().b(), (zbo)localObject1);
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbkd.class
