...
class zbjj
  extends zcp
{
  zbjj(zr paramzr, float paramFloat1, float paramFloat2, zbni paramzbni)
  {
  ...
  zq b(zq paramzq)
  {
    ...
    {
    case 3: 
      arrayOfzo[0] = new zo(this.g, (localzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[1] = new zo(f2 + this.g, (localzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[2] = new zo(f2 + this.g, this.h);
      arrayOfzo[3] = new zo(localzq.h() + this.g, localzq.i() / 2.0F + this.h);
      arrayOfzo[4] = new zo(f2 + this.g, localzq.i() + this.h);
      arrayOfzo[5] = new zo(f2 + this.g, localzq.i() - (localzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[6] = new zo(this.g, localzq.i() - (localzq.i() - f1) / 2.0F + this.h);
      break;
    case 4: 
      arrayOfzo[0] = new zo(this.g, (localzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[1] = new zo(f2 + this.g, (localzq.i() - f1) / 2.0F + this.h);
      ...
      break;
    case 1: 
      arrayOfzo[0] = new zo(this.g, localzq.i() / 2.0F + this.h);
      arrayOfzo[1] = new zo(localzq.h() - f2 + this.g, this.h);
      arrayOfzo[2] = new zo(localzq.h() - f2 + this.g, (localzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[3] = new zo(localzq.h() + this.g, (localzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[4] = new zo(localzq.h() + this.g, (localzq.i() - f1) / 2.0F + f1 + this.h);
      arrayOfzo[5] = new zo(localzq.h() - f2 + this.g, localzq.i() - (localzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[6] = new zo(localzq.h() - f2 + this.g, localzq.i() + this.h);
      f3 = (arrayOfzo[2].e() - arrayOfzo[1].e()) * (arrayOfzo[1].d() - arrayOfzo[0].d()) / (arrayOfzo[0].e() - arrayOfzo[1].e());
      paramzq.a(arrayOfzo[2].d() - f3);
      paramzq.b(arrayOfzo[2].e());
      paramzq.c(arrayOfzo[3].d() - arrayOfzo[2].d() + f3);
      paramzq.d(arrayOfzo[4].e() - arrayOfzo[3].e());
      break;
    case 2: 
      arrayOfzo[0] = new zo(this.g, localzq.i() / 2.0F + this.h);
      arrayOfzo[1] = new zo(localzq.h() - f2 + this.g, this.h);
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbjj.class
