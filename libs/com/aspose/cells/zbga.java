...
class zbga
  extends zcp
{
  zbga(zr paramzr, float paramFloat1, float paramFloat2, zbni paramzbni)
  {
  ...
  com.aspose.cells.b.a.b.a.ze a(zq paramzq)
  {
    ...
    case 1: 
      ...
      arrayOfzo[4] = new zo(f1 + (f3 - f9), f2 + f4);
      arrayOfzo[5] = new zo(f1, f2 + f4);
      arrayOfzo[6] = new zo(f1, f2 + (f4 - f5));
      arrayOfzo[7] = new zo(f1 + (f3 - f5 - f9), f2 + (f4 - f5));
      arrayOfzo[8] = new zo(f1 + (f3 - f5 - f9), f2 + f7);
      break;
    case 2: 
      ...
      arrayOfzo[4] = new zo(f1 + (f3 - f9), f2);
      arrayOfzo[5] = new zo(f1, f2);
      arrayOfzo[6] = new zo(f1, f2 + f5);
      arrayOfzo[7] = new zo(f1 + (f3 - f5 - f9), f2 + f5);
      arrayOfzo[8] = new zo(f1 + (f3 - f5 - f9), f2 + f4 - f7);
      break;
    case 3: 
      ...
      arrayOfzo[4] = new zo(f1 + f9, f2);
      arrayOfzo[5] = new zo(f1 + f3, f2);
      arrayOfzo[6] = new zo(f1 + f3, f2 + f5);
      arrayOfzo[7] = new zo(f1 + f5 + f9, f2 + f5);
      arrayOfzo[8] = new zo(f1 + f5 + f9, f2 + f4 - f7);
      break;
    case 4: 
      ...
      arrayOfzo[4] = new zo(f1 + f9, f2 + f4);
      arrayOfzo[5] = new zo(f1 + f3, f2 + f4);
      arrayOfzo[6] = new zo(f1 + f3, f2 + f4 - f5);
      arrayOfzo[7] = new zo(f1 + f5 + f9, f2 + f4 - f5);
      arrayOfzo[8] = new zo(f1 + f5 + f9, f2 + f7);
    }
    localze.b(arrayOfzo);
    return localze;
  }
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbga.class
