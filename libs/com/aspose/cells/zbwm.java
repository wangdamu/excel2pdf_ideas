...
class zbwm
{
    ...
    throws Exception
  {
    ...
    zn.a(localzi);
    float f1 = (float)(((za)localObject).i() * b() / 100.0D);
    float f2 = (float)(((za)localObject).h() * d() / 100.0D);
    float f3 = ((za)localObject).i() - (float)(((za)localObject).i() * c() / 100.0D);
    float f4 = ((za)localObject).h() - (float)(((za)localObject).h() * e() / 100.0D);
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbwm.class
