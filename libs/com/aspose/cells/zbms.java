  ...
  extends zcp
{
  ...
  zbms(zr paramzr, float paramFloat1, float paramFloat2, zbni paramzbni)
  {
  ...
  {
    this.l = new zq(paramzq.f(), paramzq.g(), paramzq.h(), paramzq.i());
    float f1 = this.g;
    float f2 = this.h;
    float f3 = this.e.y().h();
    float f4 = this.e.y().i();
    ...
    case 2: 
      ...
      localze.b(arrayOfzo);
      this.l = new zq(arrayOfzo[0], new zt(arrayOfzo[1].d() - arrayOfzo[0].d(), f4));
      break;
    case 3: 
    case 4: 
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbms.class
