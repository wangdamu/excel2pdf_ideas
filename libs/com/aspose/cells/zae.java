...
class zae
  extends zcp
{
  zae(zr paramzr, float paramFloat1, float paramFloat2, zbni paramzbni)
  {
    ...
    throws Exception
  {
    ...
    this.a.b(localzs, f1 + f5 + f17, f2 + f6 + f19, f1 + f7 + f17, f2 + f8 + f19);
    this.a.b(localzs, f1 + f7 + f17, f2 + f8 + f19, f1 + f9 + f17, f2 + f10 + f19);
    this.a.b(localzs, f1 + f9 + f17, f2 + f10 + f19, f1 + f11 + f17, f2 + f12 + f19);
    this.a.b(localzs, f1 + f5 + f17, f2 + f2 + f19, f1 + f5 + f17, f2 + f4 + f19);
    a();
  }
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zae.class
