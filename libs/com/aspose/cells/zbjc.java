...
class zbjc
  extends zco
{
  zbjc(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
  ...
  private com.aspose.cells.b.a.b.a.ze a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt)
  {
    ...
    if (this.e.l.a.size() > 0) {
      ...
      f1 = 2588.0F * (this.e.f() > this.e.g() ? this.e.g() : this.e.f()) / 21600.0F;
    }
    float f2 = f1;
    switch (this.e.a)
    {
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbjc.class
