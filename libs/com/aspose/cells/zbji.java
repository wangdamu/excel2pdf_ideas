...
class zbji
  extends zco
{
  zbji(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
  ...
  com.aspose.cells.b.a.b.a.ze a(zq paramzq)
  {
    ...
    {
    case 3: 
      arrayOfzo[0] = new zo(this.g, (paramzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[1] = new zo(f2 + this.g, (paramzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[2] = new zo(f2 + this.g, this.h);
      arrayOfzo[3] = new zo(paramzq.h() + this.g, paramzq.i() / 2.0F + this.h);
      arrayOfzo[4] = new zo(f2 + this.g, paramzq.i() + this.h);
      arrayOfzo[5] = new zo(f2 + this.g, paramzq.i() - (paramzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[6] = new zo(this.g, paramzq.i() - (paramzq.i() - f1) / 2.0F + this.h);
      break;
    case 4: 
      arrayOfzo[0] = new zo(this.g, (paramzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[1] = new zo(f2 + this.g, (paramzq.i() - f1) / 2.0F + this.h);
    ...
    case 1: 
      ...
      arrayOfzo[3] = new zo(paramzq.h() + this.g, (paramzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[4] = new zo(paramzq.h() + this.g, (paramzq.i() - f1) / 2.0F + f1 + this.h);
      arrayOfzo[5] = new zo(paramzq.h() - f2 + this.g, paramzq.i() - (paramzq.i() - f1) / 2.0F + this.h);
      arrayOfzo[6] = new zo(paramzq.h() - f2 + this.g, paramzq.i() + this.h);
      break;
    case 2: 
      arrayOfzo[0] = new zo(this.g, paramzq.i() / 2.0F + this.h);
      arrayOfzo[1] = new zo(paramzq.h() - f2 + this.g, this.h);
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbji.class
