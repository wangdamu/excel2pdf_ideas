...
class zbja
  extends zco
{
  zbja(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
  ...
  com.aspose.cells.b.a.b.a.ze a(zq paramzq)
  {
    ...
    arrayOfzo[3] = new zo(paramzq.h() - f + this.g, paramzq.i() + this.h);
    arrayOfzo[4] = new zo(f + this.g, paramzq.i() + this.h);
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbja.class
