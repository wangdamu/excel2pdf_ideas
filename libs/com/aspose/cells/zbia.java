  ...
  extends zco
{
  ...
  zbia(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
    ...
    throws Exception
  {
    ...
    zc localzc6 = zbya.a(this.e.m(), localze6, 0.8F, 0.0F);
    if (!this.e.m().a())
    {
  ...
  com.aspose.cells.b.a.b.a.ze a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt)
  {
    ...
    if (this.e.l.a.size() == 2)
    {
      ...
      this.i = (this.e.f() / 3.0F * com.aspose.cells.b.a.ze.a(Float.valueOf(21600.0F - ((zar)this.e.l.a.get(1)).a())) / 21600.0F);
    }
    else if (this.e.l.a.size() == 1)
    {
      ...
      if (((zar)this.e.l.a.get(0)).b() == 328) {
        this.i = (this.e.f() / 3.0F * com.aspose.cells.b.a.ze.a(Float.valueOf(21600.0F - ((zar)this.e.l.a.get(0)).a())) / 21600.0F);
      } else {
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbia.class
