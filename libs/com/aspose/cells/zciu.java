...
class zciu
{
  ...
  zciu(WorksheetCollection paramWorksheetCollection)
  {
  ...
  String a(int paramInt1, int paramInt2, byte[] paramArrayOfByte, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      ...
      case 23: 
        i++;
        int n = zc.e(paramArrayOfByte, i) & 0xFFFF;
        if (n != 0)
        {
          str1 = Encoding.getUnicode().a(paramArrayOfByte, i + 2, 2 * n);
          str1 = zw.a(str1, "\"", "\"\"");
        }
        i += 2 * n + 2;
        zf.a(localArrayList, Integer.valueOf(this.b.length()));
      ...
      case 100: 
        ...
        i++;
        if (this.a) {
          this.b.append("[." + b(paramArrayOfByte, i) + "]");
        } else {
          this.b.append(b(paramArrayOfByte, i));
        }
        i += 6;
      ...
      case 108: 
        ...
        i++;
        if (this.a) {
          this.b.append("[." + c(paramArrayOfByte, i, paramInt3, paramInt4) + "]");
        } else {
          this.b.append(c(paramArrayOfByte, i, paramInt3, paramInt4));
        }
        i += 6;
      ...
      case 121: 
        zf.a(localArrayList, Integer.valueOf(this.b.length()));
        i++;
        int i2 = zc.e(paramArrayOfByte, i) & 0xFFFF;
        int i3 = this.c.r().c(i2);
        zbti localzbti = null;
        if ((this.c.w() != null) && (i3 < this.c.w().getCount()))
        {
          localzbti = this.c.w().a(i3);
          if (localzbti.e()) {
            localzbti = null;
          }
        }
        i += 2;
        int i4 = zc.e(paramArrayOfByte, i) & 0xFFFF;
        if (localzbti == null)
        {
          localObject = this.c.getNames().get(i4 - 1);
          this.b.append(((Name)localObject).getText());
        }
        else if (localzbti.f())
        {
          localObject = (zwh)localzbti.b().get(i4 - 1);
      ...
      case 122: 
        ...
        str2 = a(paramArrayOfByte, i, (boolean[])localObject);
        m = localObject[0];
        if (m != 0)
        {
          i += 2;
  ...
  private String a(byte[] paramArrayOfByte, int paramInt, boolean[] paramArrayOfBoolean)
  {
  ...
  private String a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    int j = zcjb.a(paramArrayOfByte, paramInt1 + 8);
    int k = zc.a(paramArrayOfByte, paramInt1 + 4);
    ...
    if ((i == 0) && (k == 1048575))
    {
      ...
      CellsHelper.a(localStringBuilder, j);
      localStringBuilder.append(':');
      localStringBuilder.append('.');
      if (i3 != 0) {
        localStringBuilder.append("$");
    ...
    if (i1 != 0) {
      localStringBuilder.append('$');
    } else if (j + paramInt3 > 16383) {
      j = j + paramInt3 - 16383 - 1;
    } else {
      j += paramInt3;
    }
    CellsHelper.a(localStringBuilder, j);
    if (n != 0) {
      localStringBuilder.append('$');
    } else if (i + paramInt2 > 1048575) {
      i = i + paramInt2 - 1048575 - 1;
    } else {
      i += paramInt2;
    }
    localStringBuilder.append(i + 1);
    ...
    if (i3 != 0) {
      localStringBuilder.append('$');
    } else if (m + paramInt3 > 16383) {
      m = m + paramInt3 - 16383 - 1;
    } else {
      m += paramInt3;
    }
    CellsHelper.a(localStringBuilder, m);
    if (i2 != 0) {
      localStringBuilder.append('$');
    } else if (k + paramInt2 > 1048575) {
      k = k + paramInt2 - 1048575 - 1;
    } else {
      k += paramInt2;
    }
    localStringBuilder.append(k + 1);
  ...
  private String b(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((i == 0) && (j == 1048575))
    {
      ...
      CellsHelper.a(localStringBuilder, k);
      localStringBuilder.append(':');
      localStringBuilder.append('.');
      if (i3 != 0) {
        localStringBuilder.append("$");
  ...
  private String c(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    int i = zcjb.a(paramArrayOfByte, paramInt1, paramInt2, paramArrayOfByte[(paramInt1 + 5)]);
    int j = zcjb.b(paramArrayOfByte, paramInt1 + 4, paramInt3, paramArrayOfByte[(paramInt1 + 5)]);
    int k = paramArrayOfByte[(paramInt1 + 5)];
    StringBuilder localStringBuilder = new StringBuilder();
    if ((k & 0xFF & 0x40) == 0) {
      localStringBuilder.append('$');
    }
    ...
    localStringBuilder.append(CellsHelper.rowIndexToName(i));
    return zs.a(localStringBuilder);
  }
  ...
  private String b(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    int j = zcjb.a(paramArrayOfByte, paramInt + 4);
    boolean bool1 = true;
    boolean bool2 = true;
    ...
    return CellsHelper.a(i, j, bool1, bool2);
  }
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zciu.class
