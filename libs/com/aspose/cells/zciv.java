...
class zciv
{
  ...
  zciv(WorksheetCollection paramWorksheetCollection)
  {
  ...
  String a(Cell paramCell)
  {
    ...
    if (arrayOfByte[i] == 1)
    {
      ...
      if (localzbf == null)
      {
        int j = zc.a(arrayOfByte, i + 1);
        int k = zcjb.a(arrayOfByte, i + 5);
        Cell localCell = paramCell.d.getRows().a.a(j, k);
        if (localCell != null) {
  ...
  String a(int paramInt1, int paramInt2, byte[] paramArrayOfByte, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    {
      this.d = paramInt2;
      this.e = (i + paramInt2 + 4);
      j = i + paramInt2;
    }
    else if (i == -1)
    {
      i = 4;
      this.d = zc.a(paramArrayOfByte, 0);
      j = i + this.d;
      this.e = (i + this.d + 4);
    }
    else
    ...
    while (i < j)
    {
      ...
      case 23: 
        ...
        if (m != 0)
        {
          str1 = Encoding.getUnicode().a(paramArrayOfByte, i + 2, 2 * m);
          str1 = zw.a(str1, "\"", "\"\"");
        }
        i += 2 * m + 2;
        zf.a(localArrayList, Integer.valueOf(this.b.length()));
      ...
      case 24: 
        ...
        String str3 = a(paramArrayOfByte, arrayOfInt, paramInt3, paramInt4, false);
        i = arrayOfInt[0];
        this.b.append(str3);
        break;
      case 25: 
        i++;
        arrayOfInt = new int[] { i };
        a(paramArrayOfByte, arrayOfInt, localArrayList);
        i = arrayOfInt[0];
        break;
      case 28: 
        zf.a(localArrayList, Integer.valueOf(this.b.length()));
      ...
      case 29: 
        ...
        break;
      case 30: 
        int n = zc.e(paramArrayOfByte, i + 1);
        zf.a(localArrayList, Integer.valueOf(this.b.length()));
        this.b.append(zp.a(n & 0xFFFF));
        i += 3;
        break;
      case 31: 
      ...
      case 108: 
        zf.a(localArrayList, Integer.valueOf(this.b.length()));
        i++;
        this.b.append(a(paramArrayOfByte, i, i + 4, paramInt3, paramInt4));
        i += 6;
        break;
      case 45: 
      case 77: 
      ...
      case 121: 
        ...
        int i2 = this.c.r().c(i1);
        zbti localzbti = null;
        if ((this.c.w() != null) && (i2 < this.c.w().getCount()))
        {
          localzbti = this.c.w().a(i2);
          if (localzbti.e()) {
            localzbti = null;
          }
        }
        i += 2;
        int i3 = zc.e(paramArrayOfByte, i) & 0xFFFF;
        Object localObject;
        if (localzbti == null)
        {
          localObject = this.c.getNames().get(i3 - 1);
          String str4;
          if (((Name)localObject).getSheetIndex() == 0)
          {
            if (this.c.p().getFileName() != null)
            {
              str4 = zu.b(this.c.p().getFileName());
              if (zamm.b(str4))
              {
                this.b.append('\'');
                this.b.append(str4);
            ...
            this.b.append(((Name)localObject).getText());
          }
          else
          {
            str4 = this.c.get(((Name)localObject).getSheetIndex() - 1).getName();
            if ((str4.indexOf(" ") != -1) || (str4.indexOf("-") != -1) || (str4.indexOf("&") != -1) || (zarb.c(str4)) || (zcja.a(str4))) {
              str4 = "'" + str4 + "'";
            }
            this.b.append(str4 + "!" + ((Name)localObject).getText());
          }
        }
        else if (localzbti.f())
        {
          localObject = (zwh)localzbti.b().get(i3 - 1);
          this.b.append(((zwh)localObject).e().toUpperCase());
        }
        else
        {
          return null;
  ...
  private void a(byte[] paramArrayOfByte, ArrayList paramArrayList)
  {
    ...
    this.b.append('{');
    int i = zc.a(paramArrayOfByte, this.e);
    this.e += 4;
    int j = zc.a(paramArrayOfByte, this.e);
    this.e += 4;
    for (int k = 0; k < j; k++)
    {
      for (int m = 0; m < i; m++) {
        ...
        case 1: 
          ...
          {
            this.b.append("\"");
            String str = Encoding.getUnicode().a(paramArrayOfByte, this.e + 2, n * 2);
            this.e += 2 + n * 2;
            this.b.append(str);
            this.b.append("\"");
          }
          ...
          break;
        case 2: 
          this.b.append(paramArrayOfByte[(this.e + 1)] == 1);
          if (m != i - 1) {
            this.b.append(',');
          }
          this.e += 2;
  ...
  private String a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    int j = zc.a(paramArrayOfByte, paramInt1 + 4);
    int k = zcjb.a(paramArrayOfByte, paramInt1 + 8);
    int m = zcjb.a(paramArrayOfByte, paramInt1 + 10);
    StringBuilder localStringBuilder = new StringBuilder();
    int n = 1;
    int i1 = 1;
    int i2 = 1;
    int i3 = 1;
    if ((paramArrayOfByte[(paramInt1 + 9)] & 0xFF & 0x80) != 0) {
      n = 0;
    }
    if ((paramArrayOfByte[(paramInt1 + 9)] & 0xFF & 0x40) != 0) {
      i1 = 0;
    }
    if ((paramArrayOfByte[(paramInt1 + 11)] & 0xFF & 0x80) != 0) {
      i2 = 0;
    }
    if ((paramArrayOfByte[(paramInt1 + 11)] & 0xFF & 0x40) != 0) {
      i3 = 0;
    }
    if ((i == 0) && (j == 1048575))
    {
  ...
  private String a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      localStringBuilder.append(zc.a(paramArrayOfByte, paramInt1) + 1);
    }
    else
    {
      i = zc.a(paramArrayOfByte, paramInt1);
      if (i + paramInt3 > 1048575) {
        i = i - 1048575 - 1;
      }
      if (i != 0)
      {
    ...
    {
      localStringBuilder.append(zcjb.a(paramArrayOfByte, paramInt2) + 1);
    }
    else
    {
      i = zcjb.a(paramArrayOfByte, paramInt2);
      if (i + paramInt4 > 16383) {
        i = i - 16383 - 1;
      }
      if (i != 0)
      {
  ...
  private String a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((i == 0) && (j == 1048575))
    {
      ...
      {
        i4 = zcjb.a(paramArrayOfByte, paramInt1 + 8);
        if (i4 + paramInt3 > 16383) {
          i4 = i4 - 16383 - 1;
        }
        localStringBuilder.append('[');
      ...
      if ((i3 != i1) || (k != m))
      {
        ...
        {
          i4 = zcjb.a(paramArrayOfByte, paramInt1 + 10);
          if (i4 + paramInt3 > 16383) {
            i4 = i4 - 16383 - 1;
          }
          localStringBuilder.append('[');
    ...
    localStringBuilder.append(a(paramArrayOfByte, paramInt1, paramInt1 + 8, paramInt2, paramInt3));
    localStringBuilder.append(':');
    localStringBuilder.append(a(paramArrayOfByte, paramInt1 + 4, paramInt1 + 10, paramInt2, paramInt3));
    return zs.a(localStringBuilder);
  }
  ...
  {
    int i = zc.a(paramArrayOfByte, paramInt1);
    int j = zcjb.a(paramArrayOfByte, paramInt1 + 4);
    int k = 1;
    int m = 1;
    int n = paramArrayOfByte[(paramInt1 + 5)];
    if ((n & 0xFF & 0x40) != 0) {
      m = 0;
    }
    if ((n & 0xFF & 0x80) != 0) {
    ...
    else if (j - paramInt3 != 0)
    {
      localStringBuilder.append('[');
      localStringBuilder.append(j - paramInt3);
      localStringBuilder.append(']');
    }
    return zs.a(localStringBuilder);
  }
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zciv.class
