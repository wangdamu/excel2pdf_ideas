...
class zad
  extends zcp
{
  zad(zr paramzr, float paramFloat1, float paramFloat2, zbni paramzbni)
  {
    ...
    throws Exception
  {
    ...
    this.a.b(localzs, f1 + f5 + f15, f2 + f6 + f17, f1 + f9 + f15, f2 + f10 + f17);
    this.a.b(localzs, f1 + f9 + f15, f2 + f10 + f17, f1 + f7 + f15, f2 + f8 + f17);
    this.a.b(localzs, f1 + f7 + f15, f2 + f1 + f17, f1 + f7 + f15, f2 + f4 + f17);
    a();
  }
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zad.class
