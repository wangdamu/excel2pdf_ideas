  ...
  extends zco
{
  ...
  zbmc(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
  ...
  com.aspose.cells.b.a.b.a.ze a(zq paramzq)
  {
    ...
    for (int j = 0; j < 8; j++)
    {
      arrayOfzo[0] = new zo((int)(f1 + f3 / 2.0F + Math.cos(zbks.a(j * 45)) * f3 / 2.0D), (int)(f2 + f4 / 2.0F - Math.sin(zbks.a(j * 45)) * f4 / 2.0D));
      arrayOfzo[2] = new zo((int)(f1 + f3 / 2.0F + Math.cos(zbks.a((j + 1) * 45)) * f3 / 2.0D), (int)(f2 + f4 / 2.0F - Math.sin(zbks.a((j + 1) * 45)) * f4 / 2.0D));
      arrayOfzo[1] = new zo((int)(f1 + f3 / 2.0F + Math.cos(zbks.a(22.5D + j * 45)) * f7 / 2.0D), (int)(f2 + f4 / 2.0F - Math.sin(zbks.a(22.5D + j * 45)) * f6 / 2.0D));
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbmc.class
