...
class zano
  extends zcp
{
  zano(zr paramzr, float paramFloat1, float paramFloat2, zbni paramzbni)
  {
  ...
  com.aspose.cells.b.a.b.a.ze a(zq paramzq)
  {
    ...
    if (this.e.f)
    {
      ...
      {
        localze.k();
        localze.b(f1 + f7, f2 + f8, f1 + f9, f2 + f10);
        localze.b(f1 + f9, f2 + f10, f1 + f5, f2 + f6);
      }
    }
    else
    {
      localzq = new zq(f1 + f15, f2 + f17, f3, f4);
      localze.b(localzq);
      if (true != this.k)
      {
        localze.k();
        localze.b(f1 + f7 + f15, f2 + f8 + f17, f1 + f9 + f15, f2 + f10 + f17);
        localze.b(f1 + f9 + f15, f2 + f10 + f17, f1 + f5 + f15, f2 + f6 + f17);
      }
    }
    return localze;
  }
    ...
    throws Exception
  {
    ...
    zq localzq = new zq();
    if (this.e.f) {
      localzq = new zq(this.e.u(), this.e.v(), this.e.s(), this.e.t());
    } else {
      localzq = new zq(f1 + f15, f2 + f17, f3, f4);
    }
    if (!this.e.A().a()) {
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zano.class
