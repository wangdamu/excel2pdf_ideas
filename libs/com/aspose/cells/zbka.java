...
class zbka
  extends zco
{
  static zn[] i = { new zn(0, 0), new zn(21600, 0), new zn(21600, 21600), new zn(0, 21600), new zn(0, 0), new zn(Integer.MIN_VALUE, -2147483647), new zn(-2147483646, -2147483645), new zn(-2147483644, -2147483643), new zn(-2147483642, -2147483641), new zn(-2147483642, 0), new zn(-2147483642, 21600) };
  static int[] j = { 4, 24576, 32768, 3, 43520, 32768, 1, 43520, 32803 };
  ...
  zbka(zr paramzr, float paramFloat1, float paramFloat2, zbnh paramzbnh)
  {
    ...
    throws Exception
  {
    ...
    Object localObject2 = new zbn(52, i1, i2, i3, i4, this.e.n().c(), this.e.n().f(), this.e.m().b(), (zbo)localObject1);
...
/* Location:              /media/peter/Data/gitworkspace/github/jxls_demo/libs/aspose-cells-17.10.jar!/com/aspose/cells/zbka.class
